...
argp_option Arguments::options[] = {
	...
	{"gain", 'g', "GAIN", 0, "Sets the RF gain on the OsmoSDR Source (old hardcoded def: 10, new def: 32.8)"},
	{"offset", 'e', "PPM", 0, "Frequency offset (ppm) for OsmoSDR Source (old def: 0, new def: 18.480)"},
	...
	{"sample-rate", 'r', "RATE", 0, "Samplerate in Msamples/s (def: 2.048)"},
	{"fft-width", 'w', "COUNT", 0, "Width of FFT in samples"},
	{"step", 'z', "FREQ", 0, "Increment step in MHz (def: sample-rate/2)"},
